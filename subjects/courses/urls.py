...
urlpatterns = [
    ...
    path('subjects/get/<int:pk>/', SubjectView.as_view({'get': 'retrieve'}), name='subjects-get-id'),
    path('subjects/delete/<int:pk>/', SubjectView.as_view({'delete': 'delete'}), name='subjects-delete-id'),

    path('themes/add/',  ThemeView.as_view({'post': 'add'}), name='themes-add'),
    path('themes/list/',  ThemeView.as_view({'get': 'list'}), name='themes-list'),
    path('themes/get/<int:pk>/', ThemeView.as_view({'get': 'retrieve'}), name='themes-list-id'),
    path('themes/delete/<int:pk>/', ThemeView.as_view({'delete': 'delete'}), name='themes-delete-id'),
    path('themes/getBySubjectId/<int:subject_id>/', ThemeView.as_view({'get': 'getBySubjectId',}), name='themes-bySubjects'),
    ...
    path('courses/get/<int:pk>/', CourseView.as_view({'get': 'retrieve'}), name='courses-list-id'),
    path('courses/delete/<int:pk>/', CourseView.as_view({'delete': 'delete'}), name='courses-delete-id'),
    path('courses/getBySubjectId/<int:subject_id>/', CourseView.as_view({'get': 'getBySubjectId',}), name='courses-bySubjects'),
