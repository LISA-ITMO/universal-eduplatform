...
class ResultsViewTests(TestCase):
    ...
    def setUp(self):
        ...
        Sets up test data for testing purposes.
            ...
            Creates instances of APIClient, Test, Question, Answer, Result, and Solutions
            models with predefined values to be used in subsequent tests.
    ...
    def test_add_result(self):
        """
        Tests the creation of a result record via POST request.
    ...
    def test_get_by_student_test_id(self):
        """
        Tests the retrieval of results by student and test ID.
    ...
    def test_get_by_student_id(self):
        """
        Tests the GET request for retrieving results by student ID.
    ...
    def test_get_by_test_id(self):
        """
        Tests retrieval of results by test ID.
    ...
    def test_full_student_test_id(self):
        """
        Tests the retrieval of results for a specific student and test.
    ...
    def test_full_student_id(self):
        """
        Tests the results-full-student-id endpoint with a valid student ID.
    ...
    def test_full_test_id(self):
        """
        Tests the retrieval of results by full test ID.
